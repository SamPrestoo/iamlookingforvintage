...
export type ProductsPartsFragment = { __typename: 'Products', products?: Array<{ __typename: 'ProductsProducts', id: string, name: string, description?: string | null, price: number, category: string, image?: string | null } | null> | null };
